...
export const TOOLS = [
  ...
  // Text → Video
  {
    ...
    whyPicked: "Fast generation speed with strong quality for T2V workflows, making it ideal for rapid iteration and production pipelines.",
    bestForTag: "Best for Speed",
    outcomes: ["video"],
    modalities: ["text-to-video"],
    pricing: "unknown",
    ...
    openSource: false,
    links: [
      { label: "Website", url: "https://sber.ai/", type: "primary" },
      { label: "Documentation", url: "https://sber.ai/docs", type: "docs" },
      { label: "API Docs", url: "https://sber.ai/api", type: "api" }
    ],
    bestFor: ["Fast T2V generation", "Quick iterations", "Diffusion-based video"],
    addedAt: "2025-12-24",
    curatedRank: 33,
    tags: ["video", "t2v", "fast", "diffusion"],
    strengths: [
      "Fast generation speed with diffusion architecture",
      "Strong visual quality and motion understanding",
      "API integration for production workflows",
      "Efficient for rapid iteration",
      "Good balance between speed and quality"
    ],
    gettingStarted: "Access Kandinsky 5.0 Pro through Sber AI API. Obtain API credentials and set up integration. Enter text prompts describing your video scene and motion. Generate videos with fast processing times. Review output quality and iterate quickly. Integrate into production pipelines for automated video generation. Check website for current pricing and API access options.",
    tips: [
      "Use detailed prompts describing scene and motion",
      "Leverage fast generation for rapid iteration",
      "Generate multiple variations to find best results",
      "Use API for batch processing workflows",
      "Optimize prompts for diffusion-based generation",
      "Monitor generation times and costs",
      "Combine with other tools for complete workflow"
    ],
    useCaseExamples: [
      {
        ...
        steps: [
          "Set up API integration",
          "Enter text prompts for video concepts",
          "Generate videos with fast processing",
          "Review and iterate quickly",
          "Select best variations for development"
        ]
      },
      {
        title: "Production Video Pipeline",
        description: "Integrate into production workflows for automated generation.",
        steps: [
          "Configure API for batch processing",
          "Prepare text prompts for video generation",
          "Generate videos with efficient processing",
          "Review and integrate into pipeline",
          "Monitor and optimize for efficiency"
        ]
      }
    ],
